...
def load_messages(u1, u2):
    ...
    if os.path.exists(path):
        ...
        cutoff = datetime.now(TZ) - timedelta(days=4)
...
def render_message_bubble(sender, message, timestamp, current_user, is_read=False):
    ...
    bubble_color = "#FFEAD0" if sender == current_user else "#FFDAB9"  # Example colors
    text_color = "#2D2D2D"  # Soft text color
    ...
    # Romantic Names (better font)
    if sender.lower() == "madam":
        display_name = "<span style='font-family:Poppins, sans-serif; font-style:italic;'>💖 Madam</span>"
    elif sender.lower() == "meliora":
        display_name = "<span style='font-family:Poppins, sans-serif; font-style:italic;'>❤️‍🔥 Meliora</span>"
    else:
    ...
    <div style="display:flex; justify-content:{align}; margin:6px 0;">
        <div class="chat-bubble" style="
            ...
            text-align:center;
        ">
            <b style="font-size:18px; color:{text_color};">{display_name}</b><br>{message}
