...
def render_message_bubble(sender, message, timestamp, current_user, is_read=False):
    ...
    # 🌸 Soft Pink-Peach & Lavender Combo
    if sender == current_user:
        bubble_color = "#FFD9DC"  # Light Pink-Peach
        text_color = "#3B2C35"    # Deep Mauve for contrast
        border_radius = "20px 20px 5px 20px"
    else:
        bubble_color = "#F8E6FF"  # Soft Lavender
        text_color = "#2E2E3A"    # Gentle Charcoal
